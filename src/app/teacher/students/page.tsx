...
import { updateUser, deleteStudents as deleteUsersAction, resetAllGeneralScores, getAllUsers, bulkAddStudents } from '@/app/teacher/superadmin/actions';
...
export default function StudentsPage() {
    ...
    const handleBulkAdd = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!selectedClass || !activeBranch || activeBranch === 'all' || !bulkStudentNames.trim() || (!bulkSchoolId && !newBulkSchoolName)) {
    ...
    const handleClassChange = async (studentId: string, newClassName: string) => {
        ...
        const result = await updateUser({ ...originalStudent, class: newClassName } as UserProfile);
