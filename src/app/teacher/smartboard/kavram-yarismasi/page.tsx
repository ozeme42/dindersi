...
const steps = [
  { id: 1, name: "Sınıf Seçimi", icon: <Book className="h-5 w-5" /> },
  { id: 2, name: "Ders Seçimi", icon: <Library className="h-5 w-5" /> },
  { id: 3, name: "Ünite Seçimi", icon: <ListTodo className="h-5 w-5" /> },
  { id: 4, name: "Konu Seçimi", icon: <Check className="h-5 w-5" /> },
];
...
export function KavramYarismaSetupClientPage() {
  ...
  const getGameUrl = () => {
    ...
    return `/teacher/smartboard/kavram-yarismasi/oyun?${params.toString()}`;
  }
