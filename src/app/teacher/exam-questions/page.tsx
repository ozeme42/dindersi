...
import {
    ...
    Search,
    Filter,
    LayoutGrid // LayoutGrid ikonunu ekledim, yoksa kaldırabilirim ama tasarımda kullanışlı olabilir.
} from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
...
function QuestionCard({ question, index, onEdit, onDifficultyChange, onSelect, isSelected }: { 
    ...
    const difficultyColors = {
        'Kolay': 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30 hover:bg-emerald-500/20',
        'Orta': 'bg-yellow-500/10 text-yellow-400 border-yellow-500/30 hover:bg-yellow-500/20',
        'Zor': 'bg-red-500/10 text-red-400 border-red-500/30 hover:bg-red-500/20',
    };
