        ...
        <div className="container mx-auto p-4 sm:p-6 md:p-8 pb-24 md:pb-12 relative z-10">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-3xl md:text-4xl font-black tracking-tight text-white">
                            ETKİNLİK <span className="text-cyan-400">MERKEZİ</span> (Test Alanı)
                        </h1>
                        <p className="text-slate-400 text-sm">Öğrenci etkinliklerini buradan test edebilirsiniz.</p>
                    </div>
                </div>
                ...
                <Button asChild variant="ghost" className="bg-slate-900/50 hover:bg-slate-800 border border-white/10 text-slate-300 rounded-xl h-12 px-6">
                    <Link href="/"><ArrowLeft className="mr-2 h-5 w-5"/> Panele Dön</Link>
                </Button>
            </div>
