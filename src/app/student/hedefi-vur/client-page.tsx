...
import { 
    ...
    PartyPopper, Gamepad2, Star, ChevronRight, Lock 
} from "lucide-react";
...
export function HedefiVurSetupClientPage() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        ...
        setCourses(finalCourses.map(c => ({...c, icon: '🎯'}))); // Add icon for display
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#1a0b2e] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900 via-[#1a0b2e] to-black p-4 sm:p-6 md:p-8 pb-20 font-sans selection:bg-purple-500/30 text-white flex flex-col items-center">
