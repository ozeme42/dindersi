...
import { ArrowRight, BookOpen, Trophy, CheckCircle2, Star, Gamepad2, ListTodo, Rocket, GraduationCap, Library, Sun, Repeat, ShoppingCart, Package, Columns, LayoutTemplate, FileCog, Crown, Award, Zap, Target, Sparkles, Map, Swords, Backpack, Loader2, Home, User } from 'lucide-react';
...
function StudentDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        const studentVisibleCourses = coursesSnapshot.docs.map(d => d.data() as Course).filter(c => !c.isTeacherOnly);
        ...
        const lessonProgressSnapshot = await getDocs(collection(db, `users/${user.uid}/progress`));
        ...
        grandTotalTopics = allTopicsSnapshot.size;
  ...
  return (
    <div className="min-h-full bg-[#2b1055] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900 via-[#2b1055] to-black p-4 sm:p-6 md:p-8 pb-32 md:pb-8 text-white font-sans selection:bg-purple-500/30">
