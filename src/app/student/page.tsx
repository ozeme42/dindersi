...
function HardestWorkersToday() {
    ...
    return (
        <GlassCard color="from-slate-800/50 to-slate-900/50" title="Günün Efsaneleri" description="Bugün en çok puan kazanan öğrenciler.">
      ...
      <div className="max-w-5xl mx-auto space-y-6">
          ...
          {/* PLAYER HUD HEADER */}
           <GlassCard className="p-1 bg-gradient-to-r from-indigo-900/50 to-purple-900/50">
              <div className="flex flex-col sm:flex-row items-center gap-6 p-6 md:p-8 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-indigo-600 text-sm font-bold px-3 py-1 rounded-full border-2 border-indigo-400 shadow-md">
                  ...
                  <div className="text-center z-10 bg-black/30 p-4 rounded-2xl border border-white/10 min-w-[160px]">
          ...
          <div className="grid grid-cols-2 gap-4">
              <GlassCard href="/student/activities" title="Etkinlikler" description="Tek başına oyna, kendini geliştir." icon={<Gamepad2 className="h-8 w-8 text-sky-300" />} color="from-sky-900/50 to-sky-800/50" />
              <GlassCard href="/student/yarismalar" title="Çok Oyunculu" description="Arkadaşlarınla yarış, rekabeti hisset." icon={<Swords className="h-8 w-8 text-rose-300" />} color="from-rose-900/50 to-rose-800/50" />
              <GlassCard href="/student/yazilacaklar" title="Yazılacaklar" description="Ders notlarını ve kavramları incele." icon={<Columns className="h-8 w-8 text-orange-300" />} color="from-orange-900/50 to-orange-800/50" />
              <GlassCard href="/student/ozetler" title="Özetler" description="Konu özetlerini gözden geçir." icon={<LayoutTemplate className="h-8 w-8 text-teal-300" />} color="from-teal-900/50 to-teal-800/50" />
              <GlassCard href="/student/shop" title="Puan Dükkanı" description="Puanlarınla profilini özelleştir." icon={<ShoppingCart className="h-8 w-8 text-lime-300" />} color="from-lime-900/50 to-lime-800/50" />
              <GlassCard href="/student/deneme" title="Deneme Sınavları" description="Öğretmeninin atadığı sınavları çöz." icon={<FileCog className="h-8 w-8 text-violet-300" />} color="from-violet-900/50 to-violet-800/50" badge={examStats.pending > 0 ? `${examStats.pending} YENİ` : undefined} />
          </div>
