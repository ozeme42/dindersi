                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
                            ...
                            <div className="flex items-center gap-3 justify-center md:justify-end">
                                ...
                                <div className="bg-black/30 backdrop-blur-md rounded-2xl p-4 border border-white/10 flex items-center gap-4 min-w-[140px] relative">
                                    ...
                                    <div className="text-left"><p className="text-xs text-orange-200/70 font-bold uppercase tracking-wider">Seri</p><p className="text-lg md:text-2xl font-black text-white tabular-nums">{user?.currentStreak || 0} Gün</p></div>
                                </div>
                            </div>
                        </div>
