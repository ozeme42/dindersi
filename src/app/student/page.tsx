    ...
    <div className="min-h-full bg-gradient-to-br from-primary/10 via-blue-50/50 to-rose-100/50 dark:from-slate-900 dark:via-slate-800 dark:to-rose-950 p-4 sm:p-6 md:p-8 pb-20 md:pb-8">
      <div className="max-w-4xl mx-auto space-y-4 md:space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
               <Button className="h-24 text-sm sm:text-base flex-col gap-1 bg-cyan-600 hover:bg-cyan-700" asChild>
                    <Link href="/student/activities"><Gamepad2 className="h-5 w-5"/> Bireysel Etkinlikler</Link>
                </Button>
                 <Button className="h-24 text-sm sm:text-base flex-col gap-1 bg-destructive hover:bg-destructive/80" asChild>
                    <Link href="/student/yarismalar"><Users className="h-5 w-5"/> Çok Oyunculu</Link>
                </Button>
          </div>
          
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Button className="h-24 text-xs sm:text-base flex-col gap-1 px-2 py-4 bg-sky-500 hover:bg-sky-600" asChild>
                  <Link href="/student/yazilacaklar"><Columns className="h-5 w-5"/> Yazılacaklar</Link>
              </Button>
              <Button className="h-24 text-xs sm:text-base flex-col gap-1 px-2 py-4 bg-orange-500 hover:bg-orange-600" asChild>
                  <Link href="/student/ozetler"><LayoutTemplate className="h-5 w-5"/> Özetler</Link>
              </Button>
              <Button className="h-24 text-xs sm:text-base flex-col gap-1 px-2 py-4 bg-green-600 hover:bg-green-700" asChild>
                  <Link href="/student/shop"><ShoppingCart className="h-5 w-5"/> Puan Dükkanı</Link>
              </Button>
              <Card className="relative">
                <Button className="w-full h-24 text-xs sm:text-base flex-col gap-1 px-2 py-4 bg-violet-600 hover:bg-violet-700" asChild>
