...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
        ...
        try {
            ...
            const [allUsersSnapshot, allCoursesSnapshot, examsResult, classesSnapshot] = await Promise.all([
            ...
            const studentVisibleCourses = allCourses.filter(c => !c.isTeacherOnly && (c.classId === studentClass?.id || !c.classId));
  ...
  return (
    <>
      <div className="min-h-full bg-[#0f041e]">
