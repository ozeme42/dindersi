...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Lightbulb } from "lucide-react";
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Tanımı verilen kavramı bul.</p>
        </div>
