...
<body>
    ...
    <script type="text/babel">
        ...
        function App() {
            ...
            const handleCorrectHit = useCallback((x, y) => {
                setScore(s => s + 10);
            ...
            const handleWrongHit = useCallback((x, y) => {
            ...
            const updateGame = useCallback((time) => {
                if (gameState !== 'playing' || levelIndex >= LEVELS.length) {
            ...
            const handleInput = (e) => {
                ...
                if (e.type === 'mousedown' || e.type === 'touchstart') shoot(Math.max(-70, Math.min(70, deg)));
            };
            ...
            const handleExit = () => {
                window.parent.postMessage('close-activity', '*');
                 if (window.parent !== window) {
                    ...
                    backLink.href = '/student/activities';
                    backLink.click();
                }
            };
