...
import { 
    ...
    PartyPopper, Gamepad2, Star, ChevronRight, BookOpen
} from "lucide-react";
...
export default function IlimHazinesiSetupPage() {
            ...
            try {
                ...
                if (user.role === 'teacher' || user.role === 'superadmin') {
                    ...
                    if (studentClassId) {
                        ...
                        finalCourses = allCourses.filter(course => !course.classId && !course.isTeacherOnly).map(course => ({
                            ...course,
                            className: 'Genel'
                        }));
                    }
    ...
    const getGameUrl = () => {
        ...
        return `/student/ilim-hazinesi/oyun?${params.toString()}`;
    };
                    ...
                    <div className="animate-in zoom-in-95 duration-300">
                        <div className="bg-black/30 rounded-2xl p-6 border border-white/10 text-center space-y-6">
                            <div className="inline-flex p-4 rounded-full bg-green-500/20 ring-4 ring-green-500/10 mb-2">
                                <BookOpen className="h-12 w-12 text-green-400 animate-pulse" />
                            </div>
                            
                            <div className="space-y-2">
                                <h3 className="text-xl font-bold text-white">Hazırsan Başlayalım!</h3>
