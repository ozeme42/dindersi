...
import { Gamepad2, ArrowLeft, Search, Crosshair, Shuffle, Lightbulb, Puzzle, Skull, Layers, MousePointerClick, Trophy, Coins, BrainCircuit, Milestone, Package, Wind, BookOpen, Mic, Pencil, ClipboardCheck, Link2, ArrowDownUp } from 'lucide-react';
...
const activityTypes = [
  ...
  { href: '/student/balon-patlatma', label: 'Balon Patlatma', icon: Gamepad2, colorClass: "bg-sky-500 hover:bg-sky-600 text-white" },
];
