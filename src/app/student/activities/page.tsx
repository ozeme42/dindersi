...
const activityTypes = [
  { href: '/student/milyoner-yarismasi', label: 'Milyoner', icon: Trophy, color: 'purple' },
  { href: '/student/yazi-tura', label: 'Yazı Tura', icon: Coins, color: 'amber' },
  { href: '/student/kavram-yarismasi', label: 'Kavram Yarışması', icon: BrainCircuit, color: 'pink' },
  { href: '/student/kelime-avi', label: 'Kelime Avı', icon: Search, color: 'teal' },
  { href: '/student/kutu-ac', label: 'Kutu Aç', icon: Package, color: 'indigo' },
  { href: '/student/kavram-avi', label: 'Kavram Avı', icon: Crosshair, color: 'cyan' },
  { href: '/student/eslestirme', label: 'Eşleştirme', icon: Puzzle, color: 'blue' },
  { href: '/student/cumle-olusturma', label: 'Cümle Ustası', icon: Shuffle, color: 'orange' },
  { href: '/student/olay-siralama', label: 'Olay Sıralama', icon: ArrowDownUp, color: 'sky' },
  { href: '/student/adam-asmaca', label: 'Adam Asmaca', icon: Skull, color: 'rose' },
  { href: '/student/hafiza-kartlari', label: 'Hafıza Kartları', icon: Layers, color: 'emerald' },
  { href: '/student/kategorilere-ayir', label: 'Kategorize Et', icon: FolderKanban, color: 'lime' },
  { href: '/student/hedefi-vur', label: 'Hedefi Vur', icon: MousePointerClick, color: 'red' },
  { href: '/student/bil-bakalim', label: 'Bil Bakalım', icon: Lightbulb, color: 'yellow' },
  { href: '/student/dogru-yanlis-zinciri', label: 'D/Y Zinciri', icon: Link2, color: 'green' },
  { href: '/student/ben-kimim', label: 'Ben Kimim?', icon: BrainCircuit, color: 'fuchsia' },
  { href: '/student/acik-uclu-cevapla', label: 'Açık Uçlu', icon: Pencil, color: 'slate' },
  { href: '/student/ilim-hazinesi', label: 'İlim Hazinesi', icon: BookOpen, color: 'violet' },
  { href: '/student/labirent', label: 'Labirent', icon: Milestone, color: 'zinc' },
  { href: '/student/soru-coz', label: 'Soru Çöz', icon: ClipboardCheck, color: 'indigo' },
  { href: '/student/tornado', label: 'Tornado', icon: Wind, color: 'cyan' },
];
