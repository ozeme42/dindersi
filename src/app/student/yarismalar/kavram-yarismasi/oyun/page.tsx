                ...
                <div className="relative z-10 w-full max-w-4xl text-center space-y-8 animate-in zoom-in-95 duration-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-10">
                        <button 
                            ...
                            className="group relative bg-slate-900/60 border-2 border-slate-700 hover:border-indigo-500 rounded-3xl p-6 md:p-8 transition-all hover:shadow-[0_0_40px_rgba(99,102,241,0.3)] hover:-translate-y-2"
                        >
                            ...
                            <div className="bg-indigo-500/10 w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:scale-110 transition-transform border border-indigo-500/20">
                        ...
                        <button 
                            ...
                            className="group relative bg-slate-900/60 border-2 border-slate-700 hover:border-rose-500 rounded-3xl p-6 md:p-8 transition-all hover:shadow-[0_0_40px_rgba(244,63,94,0.3)] hover:-translate-y-2"
                        >
                            ...
                            <div className="bg-rose-500/10 w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:scale-110 transition-transform border border-rose-500/20">
                                <Users className="w-10 h-10 md:w-12 md:h-12 text-rose-400" />
                            </div>
