                ...
                <div className="relative z-10 w-full max-w-4xl text-center space-y-8 animate-in zoom-in-95 duration-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <button 
                            ...
                            className="group relative bg-slate-900/60 border-2 border-slate-700 hover:border-indigo-500 rounded-3xl p-4 transition-all hover:shadow-[0_0_40px_rgba(99,102,241,0.3)] hover:-translate-y-2"
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Tek Kişilik</h3>
                            <p className="text-slate-400 text-sm">Puan topla, yanlış yaparsan puanın düşer.</p>
                        </button>

                        <button 
                            onClick={() => startGame('team')}
                            className="group relative bg-slate-900/60 border-2 border-slate-700 hover:border-rose-500 rounded-3xl p-4 transition-all hover:shadow-[0_0_40px_rgba(244,63,94,0.3)] hover:-translate-y-2"
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">Düello (VS)</h3>
                            <p className="text-slate-400 text-sm">Arkadaşınla kapış. Puan kaydedilmez.</p>
                        </button>
                    </div>
