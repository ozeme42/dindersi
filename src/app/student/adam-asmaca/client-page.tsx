...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Skull } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-headline flex items-center justify-center gap-2">
            <Skull className="h-8 w-8 text-slate-500"/>
            Adam Asmaca
          </h1>
          <p className="text-muted-foreground">İpucunu kullan, harfleri seç ve kelimeyi bul.</p>
        </div>
