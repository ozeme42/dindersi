...
function HangmanGame() {
    ...
    const currentData = useMemo(() => gameData?.[currentWordIndex], [gameData, currentWordIndex]);
                    ...
                    <div className="flex-grow flex flex-col items-center w-full space-y-6">
                        ...
                        <div className="flex justify-center gap-2 md:gap-3 flex-wrap">
                            {targetWord.split('').map((letter, i) => (
                                <div key={i} className={cn(
                                    ...
                                    (guessedLetters.has(letter) || gameState === 'lost') && "bg-white text-primary border-primary/50",
                        ...
                        {gameState === 'playing' ? (
                            ...
                            <div className="p-4 rounded-md min-h-[14rem] flex flex-col justify-center">
                                ...
                                {gameState === 'lost' && <p className="text-muted-foreground">Doğru kelime: <span className="font-bold">{targetWord}</span></p>}
                            </div>
                        )}
                    </div>
                </CardContent>
