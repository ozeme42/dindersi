...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, FolderKanban } from "lucide-react";
...
export function KategorilereAyirSetupClientPage() {
  const { user } = useAuth();
  ...
  const getGameUrl = () => {
    ...
    return `/student/kategorilere-ayir/oyun?${params.toString()}`;
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">İlgili kavramları doğru kategorilere yerleştir.</p>
        </div>
