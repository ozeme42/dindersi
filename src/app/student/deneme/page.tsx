                            ...
                            <CardFooter className="bg-muted/30 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                {isSolved ? (
                                    <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
                                        ...
                                        <div className="flex items-center gap-1.5"><Trophy className="h-4 w-4 text-amber-500"/> Derece: <span className="font-bold">{assignment.rank} / {assignment.totalParticipants}</span></div>
                                    </div>
                                ) : (
