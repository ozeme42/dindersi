...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Puzzle } from "lucide-react";
...
export function EslestirmeSetupClientPage() {
  const { user } = useAuth();
  ...
  const getGameUrl = () => {
    ...
    return `/student/eslestirme/oyun?${params.toString()}`;
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8 pb-20 md:pb-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Kavramları doğru tanımlarıyla eşleştir.</p>
        </div>
