...
import { 
    ...
    PartyPopper, Trophy, Gamepad2, Star, ChevronRight
} from "lucide-react";
...
export function MilyonerSetupClientPage() {
  const { user } = useAuth();
                ...
                <div className="animate-in zoom-in-95 duration-300">
                    <div className="bg-black/30 rounded-2xl p-6 border border-white/10 text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h3 className="text-xl font-bold text-white">Yarışmaya Hazır Mısın?</h3>
                        ...
                        <Link href={`/student/milyoner-yarismasi/oyun?${params.toString()}`} className="block w-full">
      ...
      <div className="w-full max-w-2xl flex items-center justify-between mb-8">
          ...
          <div className="text-center">
              <h1 className="text-2xl font-black uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-indigo-200 flex items-center gap-2 justify-center">
                  <Trophy className="h-6 w-6 text-indigo-400 mb-1" />
                  Milyoner
              </h1>
