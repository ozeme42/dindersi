...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Trophy } from "lucide-react";
...
export function MilyonerSetupClientPage() {
  ...
  const getGameUrl = () => {
    ...
    return `/student/milyoner-yarismasi/oyun?${params.toString()}`;
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Son soruya kadar ilerle ve büyük ödülü kazan.</p>
        </div>
