...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Wind, User, Users, BookOpen } from "lucide-react";
            ...
            return (
              <div className="space-y-8 text-center w-full max-w-lg">
                ...
                <div className="space-y-4 pt-8 border-t">
                    <h3 className="text-xl font-semibold font-headline">Oyun Modunu Seç</h3>
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Button asChild size="lg" className="h-28 text-lg flex-col gap-2">
                           <Link href={getGameUrl(1)}>
                               ...
                               <div>
                                   <p>Tek Kişi</p>
                                   <p className="text-xs font-normal opacity-80">(Puan Kazan)</p>
                               </div>
                           </Link>
                        </Button>
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Kutuları aç, soruları bil, puanları topla!</p>
        </div>
