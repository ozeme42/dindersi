...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Crosshair } from "lucide-react";
...
export function KavramAviSetupClientPage() {
  ...
  const getGameUrl = () => {
    ...
    return `/student/kavram-avi/oyun?${params.toString()}`;
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Oynamak için bir konu seç.</p>
        </div>
