...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Search } from "lucide-react";
...
export function KelimeAviSetupClientPage() {
  const { user } = useAuth();
  ...
  const getGameUrl = () => {
    ...
    return `/student/kelime-avi/oyun?${params.toString()}`;
  }
    ...
    <div className="container mx-auto p-4 sm:p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Karışık harfler arasına gizlenmiş kelimeleri bul.</p>
        </div>
