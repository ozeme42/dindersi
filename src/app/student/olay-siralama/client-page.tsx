...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, ArrowDownUp } from "lucide-react";
...
export function OlaySiralamaSetupClientPage() {
  const { user } = useAuth();
  ...
  const getGameUrl = () => {
    ...
    return `/student/olay-siralama/oyun?${params.toString()}`;
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-headline flex items-center justify-center gap-2">
            <ArrowDownUp className="h-8 w-8 text-sky-500"/>
            Olay Sıralama
          </h1>
          <p className="text-muted-foreground">Olayları kronolojik olarak doğru sıraya koy.</p>
        </div>
