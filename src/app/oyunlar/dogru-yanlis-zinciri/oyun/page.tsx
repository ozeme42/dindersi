...
function TrueFalseChainGame() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-green-950 text-white p-4 items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full max-w-4xl z-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Button onClick={() => handleAnswer(true)} className="h-32 md:h-48 text-3xl font-black bg-green-600 hover:bg-green-500 shadow-lg shadow-green-900 border-b-8 border-green-800 active:border-b-0 active:translate-y-2 transition-all">
                        <CheckCircle className="mr-4 h-12 w-12"/> DOĞRU
                    </Button>
                    <Button onClick={() => handleAnswer(false)} className="h-32 md:h-48 text-3xl font-black bg-red-600 hover:bg-red-500 shadow-lg shadow-red-900 border-b-8 border-red-800 active:border-b-0 active:translate-y-2 transition-all">
