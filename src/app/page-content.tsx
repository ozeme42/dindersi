                                                    ...
                                                    {group.courses.map((course) => (
                                                        ...
                                                        >
                                                            <AccordionTrigger className="px-4 py-3 hover:bg-white/5 hover:no-underline transition-colors">
                                                                <div className="flex items-center gap-3">
                                                                    <div className={cn("h-10 w-10 rounded-xl flex items-center justify-center font-bold text-lg bg-white shadow-sm", classColorMap[course.title] || 'text-slate-500')}>
                                                                        {course.title === 'Genel' ? 'G' : course.title}
                                                                    </div>
