    ...
    return (
      <div className="h-full w-full flex flex-col bg-transparent text-slate-900 overflow-hidden relative">
        ...
        >
            ...
            {isTeacher && !hideUI && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-40">
                    <Button
                        ...
                        size="sm"
                        className="h-4 w-9 rounded-t-md rounded-b-none bg-white/80 dark:bg-slate-900/80 border-t border-x border-slate-200/80 dark:border-white/10 hover:bg-white dark:hover:bg-slate-800 text-slate-500 hover:text-slate-900 dark:hover:text-white shadow-xs backdrop-blur-md transition-all"
                    >
            ...
            {/* Şeffaf & Blur Cam Efekti Arka Plan */}
            <div className="absolute inset-0 bg-white/70 dark:bg-slate-950/70 backdrop-blur-2xl border-t border-white/60 dark:border-white/10 shadow-[0_-4px_25px_rgba(0,0,0,0.04)]" />
            ...
            <div className="relative flex items-center justify-between gap-2 px-3 py-2">
                ...
                <div className="flex items-center gap-1.5">
                    <button
                        ...
                        className="w-8 h-8 rounded-xl bg-white/80 hover:bg-white border border-slate-200/80 text-slate-700 hover:text-slate-900 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all active:scale-95 shadow-xs backdrop-blur-md"
                        title="Önceki Sayfa"
                    >
                    ...
                    <button
                        ...
                        className={cn(
                            "h-8 px-2.5 rounded-xl border flex items-center gap-1.5 text-[11px] font-black transition-all active:scale-95 shadow-xs backdrop-blur-md",
                            isDocFullscreen
                    ...
                    >
                        {isDocFullscreen ? (
                            <>
                                <Minimize className="w-3 h-3 text-rose-600" />
                    ...
                    {isTeacher && (
                        <button
                            ...
                            className="h-8 px-2.5 rounded-xl bg-white/80 hover:bg-white border border-slate-200/80 text-slate-700 hover:text-slate-900 flex items-center gap-1 text-[11px] font-bold transition-all active:scale-95 shadow-xs backdrop-blur-md"
                ...
                <div className="flex-1 flex flex-col items-center gap-0.5 max-w-xs">
                            ...
                            <div
                                ...
                                className={cn(
                                    ...
                                    idx === currentStepIndex
                                        ? "h-1.5 w-4 bg-indigo-600 shadow-[0_0_6px_rgba(79,70,229,0.5)]"
                                        : internalProgress.answers[idx]?.completed
                                            ? "h-1 w-1 bg-emerald-500"
                                            : "h-1 w-1 bg-slate-300 dark:bg-white/20"
                                )}
                            />
                        ))}
                    </div>
                    ...
                    {isTeacher ? (
                        <Select value={currentStepIndex.toString()} onValueChange={(val) => {
                            ...
                            <SelectTrigger className="h-4 px-1.5 py-0 bg-transparent border-0 shadow-none text-[10px] font-black text-slate-700 hover:text-indigo-600 focus:ring-0 focus:ring-offset-0 w-auto gap-0.5">
                        ...
                        <div className="h-4 px-1.5 py-0 flex items-center justify-center text-[10px] font-black text-slate-500">
                ...
                <div className="flex items-center gap-1.5">
                    {/* Puan rozeti */}
                    <div className="flex items-center gap-1 px-2 py-1 bg-amber-500/10 border border-amber-500/25 rounded-xl shadow-xs backdrop-blur-md">
                        ...
                        <div className="relative h-3.5 w-5 overflow-hidden">
                            <AnimatePresence mode="popLayout">
                                <motion.span
                                    ...
                                    className="absolute inset-0 text-[11px] font-black text-amber-700 text-center leading-none flex items-center justify-center"
                                >
                    ...
                    {isTeacher && (
                        <button
                            onClick={handleNext}
                            className="h-8 px-2.5 rounded-xl bg-white/80 hover:bg-amber-500/10 hover:text-amber-700 border border-slate-200/80 text-slate-600 text-[11px] font-bold transition-all active:scale-95 shadow-xs backdrop-blur-md"
                        >
                            Atla
                        </button>
                    )}
