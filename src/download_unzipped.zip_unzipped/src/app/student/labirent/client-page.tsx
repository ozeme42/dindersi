...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Milestone } from "lucide-react";
...
export function LabirentSetupClientPage() {
  const { user } = useAuth();
  ...
  const getGameUrl = () => {
    ...
    return `/student/labirent/oyun?${params.toString()}`;
  }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-headline flex items-center justify-center gap-2">
            <Milestone className="h-8 w-8 text-gray-700"/>
            Labirent Oyunu
          </h1>
          <p className="text-muted-foreground">Labirentten çıkmak için soruları doğru cevapla!</p>
        </div>
