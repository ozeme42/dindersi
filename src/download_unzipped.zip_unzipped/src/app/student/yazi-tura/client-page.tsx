...
import { ArrowLeft, ArrowRight, Check, Book, Library, ListTodo, PartyPopper, Coins } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-headline flex items-center justify-center gap-2">
            ...
            Yazı Tura (Risk Oyunu)
          </h1>
          <p className="text-muted-foreground">Bilgine güveniyor musun? Risk al ve puanını katla!</p>
        </div>
