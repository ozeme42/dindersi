...
import { ArrowLeft, Swords, Repeat, UserCheck, Award, PartyPopper, Castle, Loader2, AlertTriangle, Home, Fullscreen, Trophy } from "lucide-react";
import Link from "next/link";
import { AlertDialog } from "@/components/ui/alert-dialog";
import { getFetihGameQuestions } from "../actions";
            ...
            <div className="aspect-video w-full max-w-6xl mx-auto grid gap-1 bg-gray-300 dark:bg-gray-700 p-1" style={{ gridTemplateColumns: `repeat(${GRID_COLS}, minmax(0, 1fr))`}}>
             ...
             {openedQuestion && (
                <QuestionDialog
                    ...
                    penaltyConfig={{ 'default': { penalty: -1 } }}
